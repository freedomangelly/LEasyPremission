...
import com.lightyear.librarypremission.premission.IPermissionInterceptor;
...
import com.lightyear.librarypremission.premission.PermissionFragment;
    ...
    protected void showPermissionDialog(FragmentActivity activity, List<String> permissions) {
        ...
        new AlertDialog.Builder(activity)
                ...
                .setPositiveButton(R.string.common_permission_goto, new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        dialog.dismiss();
                        LEasyPermissions.startPermissionActivity(activity, permissions);
                    }
                })
                .show();
    }
