...
*
*/
public final class LEasyPermissions {
     ...
     */
    public static LEasyPermissions with(FragmentActivity activity) {
        return new LEasyPermissions(activity);
    }

    public static LEasyPermissions with(Context context) {
        return with(PermissionUtils.findFragmentActivity(context));
    }

    public static LEasyPermissions with(Fragment fragment) {
     ...
     * 私有化构造函数
     */
    private LEasyPermissions(FragmentActivity activity) {
        mActivity = activity;
    }
     ...
     * 添加权限
     */
    public LEasyPermissions permission(String permission) {
     ...
     * 添加权限组
     */
    public LEasyPermissions permission(String[] permissions) {
        return permission(PermissionUtils.asArrayList(permissions));
    }

    public LEasyPermissions permission(List<String> permissions) {
        if (mPermissions == null) {
